...
const Highlight = () => {
    return (
        <div className="2xl:container 2xl:mx-auto md:py-4 py-9">
            <div className=" bg-gray-50 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-8 py-8 md:px-12 px-4">
                {/* Delivery grid Card */}
                <div>
                    ...
                    <h3 className=" text-base leading-5 font-semibold text-gray-800 text-left mt-3 ">Delivery</h3>
                    <p className=" text-sm leading-6 font-normal text-gray-600 mt-2 lg:w-full md:w-9/12 w-full text-left">Free worldwide delivery over orders above $100</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className=" text-base leading-5 font-semibold text-gray-800 mt-3 text-left">Customer Care</h3>
                    <p className=" text-sm leading-6 font-normal text-gray-600 mt-2 lg:w-full md:w-9/12 w-full text-left">
                ...
                <div>
                    ...
                    <h3 className=" text-base leading-5 font-semibold text-gray-800 mt-3 text-left">Recycle</h3>
                    <p className=" text-sm leading-6 font-normal text-gray-600 mt-2 lg:w-full md:w-9/12 w-full text-left">All out products are 100 percent recycable</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className=" text-base leading-5 font-semibold text-gray-800 mt-3 text-left">Secure Payment</h3>
                    <p className=" text-sm leading-6 font-normal text-gray-600 mt-2 lg:w-full md:w-9/12 w-full text-left">Transaction process has end to end encryption</p>
                </div>
            </div>
        </div>
    );
