        ...
        <div className="flex flex-col justify-start items-start w-full space-y-9">
          <div className="flex justify-start flex-col items-start space-y-2">
            ...
            <p className="text-base leading-normal sm:leading-4 text-gray-600">
              Home {">"} ShopAll {">"} Cart {">"} Checkout
            </p>
          </div>

          <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
          <div class="w-full overflow-hidden bg-gray-100 px-2">
           {cartItems.map((product)=>{
         return(
          <div class="flex mb-2 border-t-2 border-gray-200 p-4 ">
            <div class="md:shrink-0">
              <img
                class="h-48 w-full object-cover md:h-40 md:w-40 border-gray-20 border-2"
            ...
            <div class="p-4 text-left">
              ...
              <div class=" tracking-wide text-base text-gray-500 mt-2 mb-10">
               Qty {product.quantity}
              </div>
              <Link to={`/products/${product._id}`}>
              <a href="#" class=" tracking-wide text-sm text-gray-900 underline">
               See details
              </a>
              </Link>
            </div>
            ...
            <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
              <button className="border border-transparent hover:border-gray-300 bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex flex-row justify-center items-center space-x-2 py-4  w-full">
                <div>
                  <svg
              ...
              <div className="mt-2 flex-col">
                <div className="relative">
                  <button
                    className="text-left border border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600 bg-white"
                    type="email"
                  >
                    {country}
                  </button>
              ...
              <button className="mt-8 border border-transparent hover:border-gray-300 bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex justify-center items-center py-4 w-full">
                <div>
                  <p className="text-base leading-4">Pay</p>
                </div>
              </button>
