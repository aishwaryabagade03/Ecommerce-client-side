...
import nav1 from "../assets/Navbar/nav1.jpg"
import nav2 from "../assets/Navbar/nav3.jpg"
import nav4 from "../assets/Navbar/nav4.jpg"
import nav5 from "../assets/Navbar/nav5.jpg"
  ...
  return (
    <div className="bg-white">
                          ...
                          {category.featured.map((item) => (
                            <div key={item.name} className="group relative text-sm">
                              ...
                              <a href={item.href} className="mt-6 block font-medium text-gray-900">
                                <span className="absolute drop-down inset-0 z-10" aria-hidden="true" />
                                {item.name}
                              </a>
      ...
      <header className="relative bg-white">
        ...
        <nav aria-label="Top" className="mx-auto max-w-full px-4 sm:px-6 lg:px-10 border-b border-black">
          <div>
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  ...
                  <p className="text-decoration-none text-3xl ...">M O D E R N</p>
                </a>
              </div>
                        ...
                        <>
                          ...
                          >
                            <Popover.Panel className="absolute inset-x-0 top-full text-sm text-gray-500">
                              ...
                              <div className="relative nav-background">
