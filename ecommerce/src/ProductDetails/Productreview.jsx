...
const ProductReview = () => {
    return (
        <div className="py-12 px-4 sm:px-12 container flex justify-center items-center">
            <div className="flex flex-col justify-start items-start w-full space-y-8 border-b border-gray-800">
                <div className="flex justify-start items-start w-full	border-b border-gray-800">
                    <p className="text-3xl lg:text-2xl font-semibold leading-7 lg:leading-9 text-gray-800  mb-2">Reviews</p>
                </div>
                <div className="w-full flex justify-start items-start flex-col review ">
                    <div className="flex flex-col md:flex-row justify-between w-full">
                        <div className="flex flex-row justify-between items-start ">
                            <p className="text-base font-medium leading-normal text-gray-800 ">Stunning!!</p>
                        </div>
                    ...
                    <div className="md:block" >
                        <p className="mt-3 text-sm leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">So shiny and dainty can wear them everyday . Sturdy closure.</p>
                        <div className="my-6 flex justify-start items-center flex-row space-x-2.5 ">
                            <div>
                                <img src="https://i.ibb.co/QcqyrVG/Mask-Group.png" alt="girl-avatar" />
                            </div>
                            <div className="flex flex-col justify-start items-start space-y-2">
                                <p className="text-sm font-medium leading-none text-gray-800">Anna Kendrick</p>
                                <p className="text-xs leading-none text-gray-600">14 July 2021</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full flex justify-start items-start flex-col py-6 review border-t border-gray-800">
                        <div className="flex flex-col md:flex-row flex justify-between w-full">
                            <div className="flex flex-row justify-between items-start text-left">
                                <p className="text-base font-medium leading-normal text-gray-800">So Cute</p>
                            </div>
                            <div className="cursor-pointer mt-2 md:mt-0">
                                <svg width="152" height="24" viewBox="0 0 152 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0)">
                        ...
                        <div className="md:block ">
                            <p className="mt-3 text-sm leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">They are small and simple. I wear them everyday. I love them.</p>
                            <div className="mt-6 flex justify-start items-center flex-row space-x-2.5">
                                <div>
                                    <img src="https://i.ibb.co/RCTGZTc/Mask-Group-1.png" alt="girl-avatar" />
                                </div>
                                <div className="flex flex-col justify-start items-start space-y-2">
                                    <p className="text-sm font-medium leading-none text-gray-800">James Schofield</p>
                                    <p className="text-xs leading-none text-gray-600">23 June 2021</p>
                                </div>
                            </div>
                        </div>
                    </div>
