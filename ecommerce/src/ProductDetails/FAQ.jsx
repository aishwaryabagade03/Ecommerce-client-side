...
import faqimg from "../assets/Quick_Action_Returns.jpeg"
const Faq = () => {
    ...
    return (
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
            <h2 className=" font-semibold lg:text-4xl text-3xl lg:leading-9 md:leading-7 leading-9 text-gray-800 text-left">Frequently Asked Questions</h2>
            <div className="mt-4 flex md:justify-between md:items-start md:flex-row flex-col justify-start items-start">
                <div className=" ">
                    <p className=" font-normal text-base leading-6 text-gray-600 lg:w-8/12 md:w-9/12 text-left">How can we help you?</p>
                    <p className=" font-normal text-base leading-6 text-gray-600 lg:w-8/12 md:w-9/12 text-left">Here are few of the most frequently asked questions by our valueable customers.</p>
                </div>
            ...
            <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
                <div className=" md:w-5/12 lg:w-4/12 w-full ">
                    <img src={faqimg} alt="Img of Glass bottle" className="w-full md:block hidden" />
                    <img src={faqimg} alt="Img of Glass bottle" className="w-full md:hidden block " />
                </div>
                <div className=" md:w-7/12 lg:w-8/12 w-full md:mt-0 sm:mt-14 mt-10">
                    ...
                    <div>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 text-left " + (show ? "block" : "hidden")}>If you need to make any changes to your order, including adjusting and cancelling of the order, or changing the shipping address, please reach out within 24 hours of placing the order. Kindly note that as our team works hard to get your order dispatched as quickly as possible, we may not be able to cancel or update your order upon request.</p>
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 text-left " + (show ? "block" : "hidden")}>We are covering every major country worldwide. The shipment leaves from US as it is our headquarter. Some extra information you probably need to add here so that the customer is clear of their wanted expectations.</p>
                    </div>
